    ...
    <div class="slideAjout">
        ...
        <div id="maison">
            <form class="" action="index.php" method="post" id="maison-text">
                <label>Nom: </label><input type="text" name="nom" id="name"><br>
                <label>Adresse: </label><input type="text" name="adresse" id="adresse"><br>
                <label>Superficie: </label><input type="text" name="superficie" id="superficie"><br>
            </form>

            <div id="submit">
                <button type="button" class="bubbly-button" onclick="addItem()">Ajouter</button>
            </div>
