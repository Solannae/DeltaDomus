...
<div id="total">
    <div class="slideAjout">
        ...
        <div class="content">
            <form class="" action="index.php" method="post" id="maison-text">
                <input type="text" name="nom" placeholder="Nom" id="name"><br>
                <input type="text" name="adresse" placeholder="Adresse" id="adresse"><br>
                <input type="text" name="superficie" placeholder="Superficie" id="superficie"><br>
            </form>
            ...
            <div id="dynamic-list" class="dynamic-list"></div>
    ...
    <div class="slideAjout">
        ...
        <div class="submit">
            <button type="button" class="bubbly-button" onclick="addItemUtilisateur()">Ajouter</button>
        </div>

        <div id="resume2" class="resume"></div>

        <div id="dynamic-list2" class="dynamic-list"></div>
    ...
    <div class="slideAjout">
        ...
        <div class="continue">
            ...
            <a onclick="" class="arrow confirm">
                <img src="data:image/svg+xml;utf8;base64," />
            </a>
        </div>
    </div>
